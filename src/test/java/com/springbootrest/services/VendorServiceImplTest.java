...
import com.springbootrest.api.v1.mapper.VendorMapper;
...
import com.springbootrest.repositories.VendorRepository;
...
//        verify(vendorRepository,times(1)).findById(anyLong());//alternate of above
