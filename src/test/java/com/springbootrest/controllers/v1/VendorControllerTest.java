...
import com.springbootrest.api.v1.model.VendorListDTO;
import com.springbootrest.services.VendorService;
...
import static com.springbootrest.controllers.v1.AbstractRestControllerTest.asJsonString;
...
//        verify(vendorService).deleteVendorById(anyLong());//looks like same as above
    }
}
